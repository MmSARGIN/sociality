...
const Postcard = () => {
    return <div className="flex w-1/3 h-3/4 rounded-lg bg-white">
        <div className="flex bg-red-400 w-1/12 rounded-l-lg">
        ...
        <div className="flex p-5 w-full flex-col">
            ...
            <div className="flex justify-center rounded-lg mt-3 items-center w-full">
                <img className="w-5/6 rounded-lg" src="https://images.pexels.com/photos/12004889/pexels-photo-12004889.jpeg?auto=compress&cs=tinysrgb&w=1600" alt="" />
            </div>
            <div className="mt-5 ml-3">
                <p className="text-gray-600 font-medium">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Numquam, molestiae impedit delectus eaque provident amet officiis eos error blanditiis perspiciatis nostruma.</p>
            </div>
            <div className="flex h-1/6 w-full justify-start items-end">
